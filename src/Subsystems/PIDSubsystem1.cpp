...
PIDSubsystem1::PIDSubsystem1() : PIDSubsystem("PIDSubsystem1", 1.0, 0.0, 0.0) {
...
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
	...
	limitSwitch1 = RobotMap::pIDSubsystem1LimitSwitch1;
	limitSwitch2 = RobotMap::pIDSubsystem1LimitSwitch2;
